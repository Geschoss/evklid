...
void log_output(log_level level, const char *message, ...)
{
  ...
  // with a "typedef char* va_list" in some case,
  // and as a result throws a strange error hare. The workaround for now is to just use __builtin_va_list,
